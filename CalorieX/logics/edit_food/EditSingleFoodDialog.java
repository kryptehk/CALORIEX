...
public class EditSingleFoodDialog {
     ...
     */
    public static void open(JFrame parentFrame, Food existingFood,
                            String mealName, String dateString, int foodIndexInMeal,
                            Consumer<Food> onFoodUpdated) {
